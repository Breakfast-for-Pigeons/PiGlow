#!/usr/bin/env python3
"""
Reverse Spiral Colors 3

This program lights up the indivdual colors like in Spiral Colors 3, but
counter clockwise instead. Then the speeed gradually increases.

....................

Functions:
- reverse_sprial_colors_3a: Lights up 1 color at a time
- reverse_sprial_colors_3b: Sleep_speed goes from 0.05 to 0.01 in
                            decrements of 0.0025
- reverse_sprial_colors_3c: Sleep_speed  is 0.01. Cycle through the LEDS
                            20 times
- reverse_sprial_colors_3d: Sleep_speed is 0. Cycle through the LEDS 100
                            times
...
def reverse_spiral_colors_3a():
    """
    Lights up 1 color at a time
    """
    LOGGER.debug("Function: reverse_sprial_colors_3a")
...
def reverse_spiral_colors_3b():
    """
    Sleep_speed goes from 0.05 to 0.01 in decrements of 0.0025
    """
    LOGGER.debug("Function: reverse_sprial_colors_3b")
...
def reverse_spiral_colors_3c():
    """
    Sleep_speed is 0.01. Cycle through the LEDS 20 times
    """
    LOGGER.debug("Function: reverse_sprial_colors_3c")
...
def reverse_spiral_colors_3d():
    """
    Sleep_speed is 0. Cycle through the LEDS 100 times
    """
    LOGGER.debug("Function: reverse_sprial_colors_3d")
...
def main():
    ...
    """
    LOGGER.debug("START")
    reverse_spiral_colors_3a()
    reverse_spiral_colors_3b()
    reverse_spiral_colors_3c()
    reverse_spiral_colors_3d()
    LOGGER.debug("END")
...
if __name__ == '__main__':
    try:
        ...
        LOG = 'Logs/10_reverse_spiral_colors_3.log'
