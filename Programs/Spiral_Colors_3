...
################################################################
# Description:                                                 #
# This is not version 3 of Spiral Colors, but a variation of   #
# it. This program lights up the indivdual colors like in      #
# Spiral Colors 2, but the lights are turned off in the same   #
# order they were turned on instead of in reverse order.       #
...
# Variables
''' Feel free to change the brightness setting below '''
led_brightness = 100
