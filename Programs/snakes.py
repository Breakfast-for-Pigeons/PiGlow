...
def snake_12():
    ...
    # Snake 12 LEDs (Same lights as Snake 21 - Because they are not
...
def snake_13():
    ...
    # Snake 13 LEDs (Same lights as Snake 31 - Because they are not
    # slithering, the order doesn't matter)
...
def snake_23():
    ...
    # Snake 23 LEDs (Same lights as Snake 32 - Because they are not
    # slithering, the order doesn't matter)
